...
public class CareerSteps {
    ...
    public void sortByEnd(){career.setSortByEnd();}
    @When("I send GET Request sort by newest")
    public void setSortByReq(){career.sortByReq();}
    @Given("I set invalid get all career information endpoint")
    public void setInvEnd(){career.setInvEnd();}
    @When("I send GET Requests")
    public void sendGetReq(){career.sendGetReq();}
